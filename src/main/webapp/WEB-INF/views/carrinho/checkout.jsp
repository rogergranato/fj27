...
<body class="cart">
  ...
  <p>
	  <font color="red">${falhaPagamento}</font>
  </p>
		...
		<table id="cart-table">
			...
			<tbody>
				<c:forEach items="${shoppingCart.list}" var="item">
					<tr>
						<td class="item-title">${item.livro.titulo}-${item.tipoLivro}</td>
			...
			<tfoot>
				<tr>
					<td colspan="2">
						...
						<form:form method="post" servletRelativeAction="/shopping/checkout">
