...
<body class="product">
			...
			<div id="header-content">
				<nav id="main-nav">
					<ul class="clearfix">
						...
						<li>
							<a href="/pages/sobre-a-casa-do-codigo" rel="nofollow">Sobre n&oacute;s</a>
						</li>
						<li>
	...
	<article id="${livro.titulo}" itemscope itemtype="http://schema.org/Book">
		<header id="product-highlight" class="clearfix">
			<div id="product-overview" class="container">
				...
				<h1 class="product-title" itemprop="name">${livro.titulo}</h1>
				<p class="product-author">
					<span class="product-author-link"></span>
				</p>

				<p itemprop="deion" class="book-deion">
					${livro.titulo}<br/>
					 Veja o <a href="<c:url value='/${livro.caminhoDoSumario}'/>" target="_blank">sum&aacute;rio</a> completo do livro!
				</p>
			</div>
		</header>
		...
		<div class="container">
			<section class="author product-detail" itemprop="author" itemscope itemtype="http://schema.org/Person">
				<h2 class="section-title" itemprop="name">${livro.titulo}</h2>
				<span itemprop="deion">
					<p class="book-deion">${livro.titulo}</p>
				</span>
			</section>
			...
			<section class="data product-detail">
				...
				<p>
					N&uacute;mero de p&aacute;ginas: <span itemprop="numberOfPages">${livro.numPaginas}</span>
				</p>
	...
	<footer id="layout-footer">
		<div class="clearfix container">
			...
			<div id="collections-footer">
				<!-- cdc-footer -->
				<p class="footer-title">Cole&ccedil;&otilde;es de Programa&ccedil;&atilde;o</p>
			...
			<div id="social-footer">
				<!-- books-footer -->
				<p class="footer-title">Links da Casa do C&oacute;digo</p>
				<ul class="footer-text-links">
					<li>
						<a href="http://livros.casadocodigo.com.br" rel="nofollow">Meus E-books</a>
					</li>
					<li>
						<a href="/pages/sobre-a-casa-do-codigo">Sobre a Casa do C&oacute;digo</a>
					</li>
					<li>
						<a href="/pages/perguntas-frequentes">Perguntas Frequentes</a>
					</li>
					<li>
						<a href="https://www.caelum.com.br">Caelum - Ensino e Inova&ccedil;&atilde;o</a>
					</li>
					<li>
			...
			<div id="newsletter-footer">
				<!-- social-footer -->
				<p class="footer-title">Receba as Novidades e Lan&ccedil;amentos</p>
